/**
 *===========================================
 * Description:SerialDetailPage 详情页面——连载
 *
 * Author:M-Liu
 *
 * CrateDate:2017/9/27
...
export default class SerialDetailPage extends BaseUIComponent{
...
class SerialDetailContent extends BaseLoadComponent{
    ...
    doLoadData(){
        ...
        this.state ={pageStatus:BaseLoadComponent.Loading};
        this.mApi.getSerialDetailData(this.mContentId).then(result=>{
